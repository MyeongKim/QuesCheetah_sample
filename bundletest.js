...
$__System.register('3', ['4'], function (_export) {
    ...
    _export('AjaxCall', AjaxCall);

    function AjaxCall(url, params, successCallback) {
        //from index
        ...
        $.ajax({
            ...
            error: function error(xhr, errmsg, err) {
                $('#tab-helper-msg').html("<div class='alert-box alert radius' data-alert>Oops! We have encountered an error: " + errmsg + "</div>");
...
$__System.register("8", ["4", "7", "9"], function (_export) {
    "use strict";

    var qc, $;

    _export("MultiAction", MultiAction);
...
$__System.register("a", ["4", "7", "9"], function (_export) {
    "use strict";
    ...
    function New() {
        ...
        $('.add-contact').click(function (e) {
            ...
            if (tabLength > 10) {} else {
                tabCount = tabCount + 1;
                var tabId = 'question_' + id;
                $(this).closest('li').before('<li><a href="#question_' + id + '">question_' + tabLength + '</a> <span> x </span></li>');
                var append_string = '<div class="tab-pane" id="' + tabId + '">' + '<form class="form-horizontal" action="" method="post">\
...
$__System.register("b", ["4", "7"], function (_export) {
    "use strict";
...
$__System.registerDynamic("f", ["e"], false, function(__require, __exports, __module) {
...
$__System.registerDynamic("9", ["f"], true, function($__require, exports, module) {
  ;
  var global = this,
    ...
    QuesCheetah.prototype.createUserAnswer = function(params, success, error) {
      ...
      var successWithSend = function() {
        ...
        if (self.receiveRealtimeResponse) {
          self.socketioAction($.extend({"api-key": self.apiKey}, params));
        }
      };
...
$__System.register("13", ["4", "7", "9", "11", "12"], function (_export) {
    "use strict";
    ...
    function Sample() {
        ...
        function check_cookie(q_id) {
            var exdays = arguments.length <= 1 || arguments[1] === undefined ? 30 : arguments[1];
        ...
        function render_dom_element(nth, q_id, title, answers) {
            ...
            var tab_string = '<li tab=' + nth + ' role="presentation" q_id=' + q_id + '>' + '<a href="#q' + q_id + '" aria-controls="q"' + q_id + ' role="tab" data-toggle="tab">Q' + nth + '</a></li>';
            ...
            if (check_cookie(q_id)) {
                ...
                $.each(answers, function (a_num, v) {
                    answers_button_string += '<button class="btn btn-default multi answerBtn" ' + 'type="button" disabled="disabled" a_num=' + a_num + ' q_id=' + q_id + '>' + answers[a_num]['answer_text'] + '<span class="badge">' + answers[a_num]['answer_count'] + '</span></button>';
                });
            } else {
                $.each(answers, function (a_num, v) {
                    answers_button_string += '<button class="btn btn-default multi answerBtn" ' + 'type="button" a_num=' + a_num + ' q_id=' + q_id + '>' + answers[a_num]['answer_text'] + '</button>';
                });
            }

            var tab_content_string = '<div role="tabpanel" class="tab-pane" id="q' + q_id + '">' + '<div class="panel panel-default">' + '<div class="panel-heading">' + '<h3 class="panel-title">' + title + '</h3></div>' + '<div class="panel-body">' + answers_button_string + '</div></div></div>';
    ...
    return {
        setters: [function (_) {}, function (_3) {
            ...
            sample_text = _4["default"];
        }, function (_5) {}],
        execute: function () {}
    };
});
$__System.register("1", ["2", "4", "5", "6", "8", "9", "13", "a", "b"], function (_export) {
    // third party modules
    //import $ from "jquery";
    ...
    var Index, Mypage, Action, MultiAction, $, Sample, New, Select;
    ...
    return {
        setters: [function (_3) {
            Index = _3.Index;
        }, function (_) {}, function (_4) {
            Mypage = _4.Mypage;
        }, function (_5) {
            Action = _5.Action;
        }, function (_6) {
            MultiAction = _6.MultiAction;
        }, function (_2) {
            $ = _2["default"];
        }, function (_7) {
            Sample = _7.Sample;
...
$__System.register('QuesCheetah/static/js/src/sample.css!github:systemjs/plugin-css@0.1.20.js', [], false, function() {});
(function(c){if (typeof document == 'undefined') return; var d=document,a='appendChild',i='styleSheet',s=d.createElement('style');s.type='text/css';d.getElementsByTagName('head')[0][a](s);s[i]?s[i].cssText=c:s[a](d.createTextNode(c));})
(".action-wrapper{min-width:300px;max-width:400px;margin:0 auto}.action-wrapper .panel-heading{text-align:left}.action-wrapper .panel-body{text-align:center}.action-wrapper .answerBtn{width:45%;margin:2.5%}.action-wrapper .answerBtn[disabled=disabled]{cursor:auto}.action-wrapper .nav-tabs a{color:#999}");
})
(function(factory) {
  factory();
});
//# sourceMappingURL=bundletest.js.map